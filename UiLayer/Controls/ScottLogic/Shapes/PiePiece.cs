...
namespace ScottLogic.Shapes
{
    ...
    class PiePiece : Shape
    {
        ...
        {           
            ...
            Point innerArcStartPoint = Util.Utils.ComputeCartesianCoordinate(RotationAngle, InnerRadius);
            innerArcStartPoint.Offset(CentreX, CentreY);

            Point innerArcEndPoint = Util.Utils.ComputeCartesianCoordinate(RotationAngle + WedgeAngle, InnerRadius);
            innerArcEndPoint.Offset(CentreX, CentreY);

            Point outerArcStartPoint = Util.Utils.ComputeCartesianCoordinate(RotationAngle, Radius);
            outerArcStartPoint.Offset(CentreX, CentreY);

            Point outerArcEndPoint = Util.Utils.ComputeCartesianCoordinate(RotationAngle + WedgeAngle, Radius);
            ...
            if (PushOut > 0)
            {
                Point offset = Util.Utils.ComputeCartesianCoordinate(RotationAngle + WedgeAngle / 2, PushOut);
